...
var _require2 = require('./helper/string'),
    substr = _require2.substr,
    startSpaceLen = _require2.startSpaceLen;
/**
...
function (_Plugin) {
  ...
  _createClass(_class, [{
    ...
    value: function visitor() {
      ...
      return {
        blockquote: function blockquote(ast) {
